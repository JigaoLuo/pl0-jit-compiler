...
TEST(ASTDot, DotFormat1) {
    ...
    const std::string expected = "digraph {\n"
                                 ...
                                 "2 [label=\" Binary Operator: +\"];\n"
                                 "2 -> 3\n"
                                 "3 [label=\" Unary Operator: +\"];\n"
                                 "3 -> 4\n"
                                 "4 [label=\" Literal:42 \"];\n"
                                 "2 -> 5\n"
                                 "5 [label=\" Unary Operator: -\"];\n"
                                 "5 -> 6\n"
                                 "6 [label=\" Literal:42 \"];\n"
                                 "}\n";
    EXPECT_EQ(testing::internal::GetCapturedStdout(), expected);
